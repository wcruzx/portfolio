...
function Home() {
  ...
  return (
    <main id="home" className="container mx-auto max-width py-12 md:flex justify-between items-center">
      <div>
        <h1
          ref={h11}
          className="text-2xl text-dark-heading dark:text-light-heading md:text-4xl xl:text-5xl xl:leading-tight font-bold"
        >
          Olá,<br></br>Me chamo<br></br>
        </h1>
        <h1
          ref={h12}
          className="text-2xl bg-clip-text bg-green-text text-transparent md:text-4xl xl:text-5xl xl:leading-tight font-bold"
        >
          {name}
        </h1>
        <h2
        ...
        <ul className="flex items-center gap-6 py-12">
          <li>
      ...
      <div className="mt-5 md:mt-0">
        <img ref={myimageref} className="w-1/2 md:ml-auto" src={img} alt="Wéverson Cruz" />
      </div>
    </main>
  );
}
